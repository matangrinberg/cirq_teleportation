...
momentH1.append(cirq.H(qubits[9]))
...
momentCN1.append(cirq.CNOT(qubits[2], qubits[7]))
momentCN1.append(cirq.CNOT(qubits[3], qubits[6]))
momentCN1.append(cirq.CNOT(qubits[4], qubits[5]))
momentCN1.append(cirq.CNOT(qubits[9], qubits[10]))
...
momentUni = []
momentUni.append(u.on(qubits[0], qubits[1], qubits[2], qubits[3], qubits[4]))
momentUni.append(u_star.on(qubits[5], qubits[6], qubits[7], qubits[8], qubits[9]))
...
momentG11.append(rgz.on(qubits[4]))

circuit.append(cirq.Moment(momentG11))

momentG12 = []
momentG12.append(rgx.on(qubits[4]))
momentG12.append(rgx.on(qubits[5]))

circuit.append(cirq.Moment(momentG12))

momentG13 = []
momentG13.append(cirq.SWAP(qubits[4], qubits[5]))
circuit.append(cirq.Moment(momentG13))

momentG14 = []
momentG14.append(rgz.on(qubits[4]))
circuit.append(cirq.Moment(momentG14))
...
momentUni2 = []
unitaryTrans = np.transpose(unitary)
uT = NQubitMatrixGate(unitaryTrans)

momentUni2.append(uT.on(qubits[5], qubits[6], qubits[7], qubits[8], qubits[9]))

circuit.append(cirq.Moment(momentUni2))
...
momentG21.append(rgz.on(qubits[9]))

circuit.append(cirq.Moment(momentG21))

momentG22 = []
momentG22.append(rgx.on(qubits[9]))
momentG22.append(rgx.on(qubits[10]))

circuit.append(cirq.Moment(momentG22))

momentG23 = []
momentG23.append(cirq.SWAP(qubits[9], qubits[10]))
circuit.append(cirq.Moment(momentG23))

momentG24 = []
momentG24.append(rgz.on(qubits[9]))
circuit.append(cirq.Moment(momentG24))


# Moment Uni3
momentUni3 = []
momentUni3.append(u_star.on(qubits[5], qubits[6], qubits[7], qubits[8], qubits[9]))

circuit.append(cirq.Moment(momentUni3))


# Moment CNOT'

momentCN2 = []
# momentCN2.append(cirq.CNOT(qubits[2], qubits[7]))
# momentCN2.append(cirq.CNOT(qubits[3], qubits[6]))
momentCN2.append(cirq.CNOT(qubits[4], qubits[5]))

circuit.append(cirq.Moment(momentCN2))

# Moment H'

momentH2 = []
# momentH2.append(cirq.H(qubits[2]))
# momentH2.append(cirq.H(qubits[3]))
momentH2.append(cirq.H(qubits[4]))

circuit.append(cirq.Moment(momentH2))

# ** Moment 6

momentProj =[]
totKey = []
momentProj.append(cirq.measure(qubits[4], qubits[5], key='M0'))
totKey.append('M0')
# momentProj.append(cirq.measure(qubits[3], qubits[6], key='M1'))
# totKey.append('M1')
...
momentM = []
momentM.append(cirq.measure(qubits[10], key='M6'))
totKey.append('M6')

circuit.append(cirq.Moment(momentM))
