...
momentCN1 = []
momentCN1.append(cirq.CNOT(qubits[0], qubits[4]))
...
momentUni2 = []
momentUni2.append(u_dagg.on(qubits[0], qubits[1], qubits[2], qubits[3], qubits[4], qubits[5], qubits[6], qubits[7]))
...
momentProj =[]
totKey = []
momentProj.append(cirq.measure(qubits[0], qubits[1], qubits[2], qubits[3], qubits[4], qubits[5], qubits[6], qubits[7], key='M0'))
totKey.append('M0')
...
r = results.multi_measurement_histogram(keys=['M0'])
