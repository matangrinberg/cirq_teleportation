...
momentUni.append(u.on(qubits[8], qubits[9], qubits[10], qubits[11], qubits[12], qubits[13], qubits[14], qubits[15]))
...
totKey.append('M0')
# momentProj.append(cirq.measure(qubits[8], key='M8'))
# totKey.append('M8')
...
r1 = results.multi_measurement_histogram(keys=['M0'])
# r2 = results.multi_measurement_histogram(keys=['M8'])
col1 = collections.Counter(r1)
# col2 = collections.Counter(r2)
