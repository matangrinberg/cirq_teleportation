...
# momentH1.append(cirq.X(qubits[5]))
# momentH1.append(cirq.X(qubits[2]))
...
momentCN1 = []
momentCN1.append(cirq.CNOT(qubits[0], qubits[3]))
momentCN1.append(cirq.CNOT(qubits[1], qubits[4]))
# momentCN1.append(cirq.CNOT(qubits[2], qubits[5]))
...
momentUni = []
momentUni.append(u.on(qubits[0], qubits[1], qubits[2]))
momentUni.append(u_star.on(qubits[3], qubits[4], qubits[5]))
...
momentProj =[]
totKey = []
# momentProj.append(cirq.measure(qubits[0], qubits[1], qubits[2], key='M0'))
# totKey.append('M0')
# momentProj.append(cirq.measure(qubits[3], qubits[4], qubits[5], key='M1'))
# totKey.append('M1')
momentProj.append(cirq.measure(qubits[0], qubits[3], key='M2'))
totKey.append('M2')
# momentProj.append(cirq.measure(qubits[1], qubits[4], key='M4'))
# totKey.append('M4')
circuit.append(cirq.Moment(momentProj))


momentProj =[]
momentProj.append(cirq.measure(qubits[5], qubits[2], key='M3'))
totKey.append('M3')
circuit.append(cirq.Moment(momentProj))
