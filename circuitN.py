...
momentH1.append(cirq.H(qubits[6]))
# momentH1.append(cirq.X(qubits[15]))
# momentH1.append(cirq.H(qubits[7]))
...
momentCN1 = []
momentCN1.append(cirq.CNOT(qubits[0], qubits[8]))
momentCN1.append(cirq.CNOT(qubits[1], qubits[9]))
momentCN1.append(cirq.CNOT(qubits[2], qubits[10]))
momentCN1.append(cirq.CNOT(qubits[3], qubits[11]))
momentCN1.append(cirq.CNOT(qubits[4], qubits[12]))
momentCN1.append(cirq.CNOT(qubits[5], qubits[13]))
momentCN1.append(cirq.CNOT(qubits[6], qubits[14]))
# momentCN1.append(cirq.CNOT(qubits[7], qubits[15]))
...
momentUni = []
momentUni.append(u.on(qubits[0], qubits[1], qubits[2], qubits[3], qubits[4], qubits[5], qubits[6], qubits[7]))
momentUni.append(u_star.on(qubits[8], qubits[9], qubits[10], qubits[11], qubits[12], qubits[13], qubits[14], qubits[15]))
...
# momentUni2 = []
#
# # momentUni2.append(u_star.on(qubits[5], qubits[6], qubits[7], qubits[8], qubits[9]))
#
...
momentProj =[]
totKey = []
momentProj.append(cirq.measure(qubits[0], qubits[8], key='M0'))
totKey.append('M0')
# momentProj.append(cirq.measure(qubits[8], qubits[9] , qubits[10] , qubits[11], qubits[12], qubits[13], qubits[14], qubits[15], key='M1'))
# totKey.append('M1')
...
momentProj =[]
momentProj.append(cirq.measure(qubits[7], qubits[15], key='M2'))
totKey.append('M2')
