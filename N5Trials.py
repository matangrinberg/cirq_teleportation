...
for it in range(trials):
    ...
    # Moment CNOT
    momentCN1 = []
    momentCN1.append(cirq.CNOT(qubits[0], qubits[5]))
    momentCN1.append(cirq.CNOT(qubits[1], qubits[6]))
    momentCN1.append(cirq.CNOT(qubits[2], qubits[7]))
    momentCN1.append(cirq.CNOT(qubits[3], qubits[8]))
    ...
    momentProj =[]
    totKey = []
    momentProj.append(cirq.measure(qubits[0], qubits[5], key='M0'))
    totKey.append('M0')
    ...
    momentProj =[]
    momentProj.append(cirq.measure(qubits[4], qubits[9], key='MF'))
    totKey.append('MF')
    circuit.append(cirq.Moment(momentProj))
    ...
    # print(r)
    cor = []
    succ = col[0, 0] + col[0, 3] + col[3, 0] + col[3, 3]
    bad = col[0, 1] + col[0, 2] + col[3, 1] + col[3, 2]
    total = succ + bad
    rate = succ / total
