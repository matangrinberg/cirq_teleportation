...
for it in range(trials):
    ...
    momentH1.append(cirq.H(qubits[8]))
    # momentH1.append(cirq.H(qubits[4]))
    circuit.append(cirq.Moment(momentH1))

    # Moment CNOT
    momentCN1 = []
    momentCN1.append(cirq.CNOT(qubits[0], qubits[10]))
    momentCN1.append(cirq.CNOT(qubits[1], qubits[11]))
    momentCN1.append(cirq.CNOT(qubits[2], qubits[12]))
    momentCN1.append(cirq.CNOT(qubits[3], qubits[13]))
    momentCN1.append(cirq.CNOT(qubits[4], qubits[14]))
    momentCN1.append(cirq.CNOT(qubits[5], qubits[15]))
    momentCN1.append(cirq.CNOT(qubits[6], qubits[16]))
    momentCN1.append(cirq.CNOT(qubits[7], qubits[17]))
    momentCN1.append(cirq.CNOT(qubits[8], qubits[18]))
    # momentCN1.append(cirq.CNOT(qubits[4], qubits[9]))
    ...
    momentUni = []
    momentUni.append(u.on(qubits[0], qubits[1], qubits[2], qubits[3], qubits[4], qubits[5], qubits[6], qubits[7], qubits[8], qubits[9]))
    momentUni.append(u_star.on(qubits[10], qubits[11], qubits[12], qubits[13], qubits[14], qubits[15], qubits[16], qubits[17], qubits[18], qubits[19]))
    circuit.append(cirq.Moment(momentUni))

    momentProj =[]
    totKey = []
    momentProj.append(cirq.measure(qubits[0], qubits[10], key='M0'))
    totKey.append('M0')
    ...
    momentProj =[]
    momentProj.append(cirq.measure(qubits[9], qubits[19], key='MF'))
    totKey.append('MF')
    circuit.append(cirq.Moment(momentProj))
    ...
    # print(r)
    cor = []
    succ = (col[0, 0] + col[0, 3] + col[3, 0] + col[3, 3])/reps

    successRates.append(succ)
    print(succ)
